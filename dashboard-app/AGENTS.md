...
- 黄金原則: [`docs/core-beliefs/index.md`](docs/core-beliefs/index.md) / 失敗ログ: [`docs/failure-log.jsonl`](docs/failure-log.jsonl) / レビューログ: [`docs/review-log.jsonl`](docs/review-log.jsonl)
